...
var options = {
    ...
    xaxis: {
        ...
        categories: ['1/1/2011', '1/1/2012', '1/1/2013', '1/1/2014', '1/1/2015', '1/1/2016', '1/1/2018', '4/1/2019', '1/1/2020', '1/1/2021', '1/1/2022'],
        axisBorder: {
            show: true,
            color: '#bec7e0',
        },
...
var options = {
    ...
    xaxis: {
        type: 'datetime',
        tickAmount: 8,
        min: new Date("01/01/2010").getTime(),
        max: new Date("01/20/2022").getTime(),
        labels: {
            rotate: -15,
            rotateAlways: true,
...
var options = {
    ...
    labels: ["Mal Charging Unit", "Online Charging Unit"],
