...
app.controller("AmendController", function ($scope, $filter, $http, $window, $cookieStore) {
    ...
    if (UserData != null) {
        ...
        function AmendGetPaged(curPage) {
            ...
            $http({
                url: encodeURI('/Ammendment/AmendmentPaged?startRecordNo=' + startRecordNo + '&rowPerPage=' + $scope.PerPage + "&whereClause=" + SearchCriteria + '&rows=' + 0),
                method: 'GET',
